<template>
  <section class="container">
    <div class="title-box">
      <h1 class="title">
        {{ nowdate }}  {{ usrname }}さんの記録
      </h1>
    </div>
    <div class="usrdata-box">
      <h2></h2>
      <ul>
        <li>身長：{{ usrHeight }}cm</li>
        <li>体重：{{ usrWeight }}kg</li>
        <li>BMI：{{ usrBmi }}</li>
        <li>体脂肪率：{{ usrFat }}%</li>
      </ul>
    </div>
...
.usrdata-box li{
  padding-left: 28px;
	line-height: 1.6em;
  background: url('~assets/image/list-illust1.png') left 0px top 2px no-repeat;
